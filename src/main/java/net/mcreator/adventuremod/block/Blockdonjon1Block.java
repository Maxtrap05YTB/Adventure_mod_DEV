...
public class Blockdonjon1Block extends AdventureModModElements.ModElement {
	@ObjectHolder("adventure_mod_:blockdonjon_1")
	public static final Block block = null;
	public Blockdonjon1Block(AdventureModModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Blockdonjon1Block.block, (int) (1)));
		}
	}
}
