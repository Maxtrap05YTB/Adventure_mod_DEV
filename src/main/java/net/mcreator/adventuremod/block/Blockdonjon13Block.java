...
public class Blockdonjon13Block extends AdventureModModElements.ModElement {
	@ObjectHolder("adventure_mod_:blockdonjon_13")
	public static final Block block = null;
	public Blockdonjon13Block(AdventureModModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blockdonjon_13");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Blockdonjon13Block.block, (int) (1)));
		}
	}
}
