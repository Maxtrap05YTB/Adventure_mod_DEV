...
public class PillierdonjonterreBlock extends AdventureModModElements.ModElement {
	@ObjectHolder("adventure_mod_:pillierdonjonterre")
	public static final Block block = null;
	public PillierdonjonterreBlock(AdventureModModElements instance) {
		super(instance, 15);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("pillierdonjonterre");
		}
