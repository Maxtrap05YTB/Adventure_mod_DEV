...
public class PorteentredonojonterreBlock extends AdventureModModElements.ModElement {
	@ObjectHolder("adventure_mod_:porteentredonojonterre")
	public static final Block block = null;
	public PorteentredonojonterreBlock(AdventureModModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("porteentredonojonterre");
		}
